...
# Lazy import to avoid circular dependency - imported when needed
from app.auth.auth_header_generator import auth_header_generator
...
class AuthHandler:
    ...
    def get_auth_headers_for_agent(self, app_key: str) -> Dict[str, str]:
        ...
        """
        try:
            # Use registry-based authentication (lazy import to avoid circular dependency)
            from app.registry.client import get_agent_auth_headers
